...
//request : 요청이 담길 데이터(POST,PUT 요청에서 사용)
export async function call(api, method, request) {
    ...
    //axios(option) : 앞서 설정한 option 객체를 이용하여 axios로 Http요청을 보낸다.
...
export function p_signup(ProductDTO){
    return call("/product","POST",ProductDTO);
}