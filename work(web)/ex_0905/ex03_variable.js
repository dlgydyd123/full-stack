...
//let : 같은 이름의 변수를 다시 선언하는 것이 불가능, 대신 대입 가능 
...
//지역에 선언된 지역변수는 지역과 하위 지역에서만 참조가 가능하다.
...
//변수 선언을 포함안 모든 선언문을 찾아내어 먼저 실행한다.
...
//초기화 단계
//값을 저장하기 위한 메모리 공간을 확보하고 암욱적으로 undefined를 할당해 초기화 한다.
...
//초기화 단계는 런타입 이후에 변수 선언문에서 이루어진다.

//console.log(b); //변수가 있다는 건 앎, 초기화가 안되어 있음
