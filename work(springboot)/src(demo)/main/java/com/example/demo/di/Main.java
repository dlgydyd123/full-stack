...
//
//			// ClassPath는 구마바에서 제공하는 기능으로, 클래스 경로 상의 모든 클래스를 탐색하고
//			// 사용할 수 있게 해준다.
...
//			// 각 ClassPath.ClassInfo 객체는 특정클래스에 대한 정보를 나타낸다.
...
//
//		Engine engine = (Engine) ac.getBean("engine"); //byName으로 객체생성
//		System.out.println("engine = " + engine);
//		
//		Truck truck = (Truck)ac.getBean(Truck.class); //byType으로 객체생성
